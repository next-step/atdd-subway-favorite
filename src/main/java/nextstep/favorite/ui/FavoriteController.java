...
public class FavoriteController {
    ...
    public ResponseEntity createFavorite(@AuthenticationPrincipal final LoginMember loginMember, @RequestBody final FavoriteRequest request) {
    ...
    public ResponseEntity deleteFavorite(@AuthenticationPrincipal final LoginMember loginMember, @PathVariable final Long id) {
