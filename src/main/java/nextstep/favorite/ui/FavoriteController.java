...
public class FavoriteController {
    ...
    public ResponseEntity<Void> delete(@AuthenticationPrincipal User user, @PathVariable Long favoriteId) {
        favoriteService.deleteById(user.getPrincipal(), favoriteId);
