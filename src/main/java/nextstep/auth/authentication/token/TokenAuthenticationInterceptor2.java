...
public class TokenAuthenticationInterceptor2 extends AuthenticationInterceptor {
    ...
    public TokenAuthenticationInterceptor2(UserDetailService customUserDetailsService, TokenAuthenticationConverter tokenAuthenticationConverter, ObjectMapper objectMapper, JwtTokenProvider jwtTokenProvider) {
