...
public class CreateLineSectionDto {

    private StationDto upStation;
    private StationDto downStation;
    private Integer distance;

    private CreateLineSectionDto() {
    }

    private CreateLineSectionDto(StationDto upStation, StationDto downStation, Integer distance) {
        this.upStation = upStation;
        this.downStation = downStation;
        this.distance = distance;
    }

    public static CreateLineSectionDto from(Section section) {
        return new CreateLineSectionDto(
    ...
    public boolean equals(Object o) {
        ...
        CreateLineSectionDto that = (CreateLineSectionDto) o;
