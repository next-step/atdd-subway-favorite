...
public class FavoriteController {
    ...
    public ResponseEntity<Void> deleteFavorite(@LoginedUser LoginUser loginUser, @PathVariable Long favoriteId) {
        favoriteService.deleteFavorite(loginUser.getUserId(), favoriteId);
