...
public class FavoriteController {
    ...
    public ResponseEntity<FavoriteResponse> removeById(LoginUser loginUser, @PathVariable Long favoriteId) {
        favoriteService.removeById(favoriteId, loginUser.getEmail());
