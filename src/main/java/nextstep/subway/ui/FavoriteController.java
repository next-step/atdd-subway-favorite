...
public class FavoriteController {
    ...
    public ResponseEntity<Void> removeFavorites(@AuthenticationPrincipal final UserDetails userDetails, @PathVariable long id) {
        favoriteService.removeFavorites(userDetails, id);
