...
public class FavoriteControllerTest {
    ...
    // TODO: 추후 3단계 리팩터링 과정에서 권한관련 테스트 쪽으로 이동 할 것 같습니다.
    ...
    @DisplayName("즐겨찾기 추가 함수는, 에러가 발생하는 경우 400 에러를 응답한다.")
    @ParameterizedTest
    @MethodSource("exceptionProvider")
    void addFavoritesTest(Class<? extends Exception> exceptionClass) throws Exception {
        // given
        Map<String, String> favoriteRequestMap = Map.of("source", "1", "target", "2");
        String jsonContent = mapToJson(favoriteRequestMap);
