...
public class FavoriteAcceptanceStep {
    ...
    public static AddFavoriteResponse 즐겨찾기_추가됨(Long startStationId, Long endStationId, String accessToken) {
        return 즐겨찾기_추가(AddFavoriteRequest.of(startStationId, endStationId), accessToken).as(AddFavoriteResponse.class);
    }
