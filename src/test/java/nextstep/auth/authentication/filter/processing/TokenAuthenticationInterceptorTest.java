...
class TokenAuthenticationInterceptorTest {
    ...
    void convert() throws IOException {
        var authenticationToken = interceptor.convert(createMockRequest());
    ...
    void authenticate() {
        ...
        var authentication = interceptor.authenticate(new AuthenticationToken(EMAIL, PASSWORD));
    ...
    void processing() throws Exception {
        ...
        interceptor.processing(new Authentication(EMAIL, List.of("ROLE_ADMIN")), response);
