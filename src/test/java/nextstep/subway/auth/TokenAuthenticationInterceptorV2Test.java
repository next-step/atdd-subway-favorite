...
class TokenAuthenticationInterceptorV2Test {
    ...
    void convert() throws IOException {
        ...
        TokenAuthenticationInterceptorV2 interceptor = new TokenAuthenticationInterceptorV2(userDetailsService, jwtTokenProvider);
