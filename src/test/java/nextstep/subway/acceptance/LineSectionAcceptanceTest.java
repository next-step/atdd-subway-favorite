...
class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        신분당선 = 지하철_노선_생성_요청(관리자토큰, lineCreateParams).jsonPath().getLong("id");
    }
    ...
    void addLineSectionMiddle() {
        // when
        Long 정자역 = 지하철역_생성_요청(관리자토큰, "정자역").jsonPath().getLong("id");
        지하철_노선에_지하철_구간_생성_요청(관리자토큰, 신분당선, createSectionCreateParams(강남역, 정자역));
    ...
    void addSectionAlreadyIncluded() {
        // when
        ExtractableResponse<Response> response = 지하철_노선에_지하철_구간_생성_요청(관리자토큰, 신분당선, createSectionCreateParams(강남역, 양재역));
    ...
    void removeLineSection() {
        ...
        // when
        지하철_노선에_지하철_구간_제거_요청(관리자토큰, 신분당선, 정자역);
    ...
    void removeLineSectionInMiddle() {
        ...
        // when
        지하철_노선에_지하철_구간_제거_요청(관리자토큰, 신분당선, 양재역);
