...
class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    void addLineSectionMiddle() {
        // when
        Long 정자역 = 관리자로_지하철역_생성_요청(관리자, "정자역").jsonPath().getLong("id");
        관리자로_지하철_노선에_지하철_구간_생성_요청(관리자, 신분당선, createSectionCreateParams(강남역, 정자역));
    ...
    void addSectionAlreadyIncluded() {
        // when
        ExtractableResponse<Response> response = 관리자로_지하철_노선에_지하철_구간_생성_요청(관리자, 신분당선, createSectionCreateParams(강남역, 양재역));
    ...
    void removeLineSectionInMiddle() {
        ...
        // when
        관리자로_지하철_노선에_지하철_구간_제거_요청(관리자, 신분당선, 양재역);
