...
class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        신분당선 = 지하철_노선_생성_요청(createLineCreateParams(강남역, 양재역))
            .jsonPath().getLong("id");
    }
    ...
    private LineRequest createLineCreateParams(Long upStationId, Long downStationId) {
        return LineRequest.of("신분당선", "bg-red-600", upStationId, downStationId, 10);
    }

    private SectionRequest createSectionCreateParams(Long upStationId, Long downStationId) {
        return SectionRequest.of(upStationId, downStationId, 6);
    }
}
