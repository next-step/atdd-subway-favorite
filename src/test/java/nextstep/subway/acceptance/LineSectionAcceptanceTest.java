...
class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        강남역 = 지하철역_생성_요청("강남역", ADMIN_TOKEN).jsonPath().getLong("id");
        양재역 = 지하철역_생성_요청("양재역", ADMIN_TOKEN).jsonPath().getLong("id");

        Map<String, String> lineCreateParams = createLineCreateParams(강남역, 양재역);
        신분당선 = 지하철_노선_생성_요청(lineCreateParams, ADMIN_TOKEN).jsonPath().getLong("id");
    }
    ...
    void addLineSectionMiddle() {
        // when
        Long 정자역 = 지하철역_생성_요청("정자역", ADMIN_TOKEN).jsonPath().getLong("id");
        지하철_노선에_지하철_구간_생성_요청(신분당선, createSectionCreateParams(강남역, 정자역), ADMIN_TOKEN);
    ...
    void addSectionAlreadyIncluded() {
        // when
        ExtractableResponse<Response> response = 지하철_노선에_지하철_구간_생성_요청(신분당선, createSectionCreateParams(강남역, 양재역), ADMIN_TOKEN);
    ...
    void removeLineSection() {
        ...
        // when
        지하철_노선에_지하철_구간_제거_요청(신분당선, 정자역, ADMIN_TOKEN);
    ...
    void removeLineSectionInMiddle() {
        ...
        // when
        지하철_노선에_지하철_구간_제거_요청(신분당선, 양재역, ADMIN_TOKEN);
