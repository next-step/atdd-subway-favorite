...
import static nextstep.subway.acceptance.LineSteps.응답_코드_확인;
import static nextstep.subway.acceptance.LineSteps.지하철_노선_생성_요청;
import static nextstep.subway.acceptance.LineSteps.지하철_노선_조회_요청;
import static nextstep.subway.acceptance.LineSteps.지하철_노선에_등록된_지하철_역_목록_확인;
...
class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    void addLineSection() {
        ...
        지하철_노선에_등록된_지하철_역_목록_확인(response, 강남역, 양재역, 정자역);
    }
    ...
    void addLineSectionMiddle() {
        ...
        ExtractableResponse<Response> response = 지하철_노선_조회_요청(신분당선);
        응답_코드_확인(response, HttpStatus.OK);
        지하철_노선에_등록된_지하철_역_목록_확인(response, 강남역, 정자역, 양재역);
    }
    ...
    void removeLineSection() {
        ...
        ExtractableResponse<Response> response = 지하철_노선_조회_요청(신분당선);
        응답_코드_확인(response, HttpStatus.OK);
        지하철_노선에_등록된_지하철_역_목록_확인(response, 강남역, 양재역);
    }
    ...
    void removeLineSectionInMiddle() {
        ...
        ExtractableResponse<Response> response = 지하철_노선_조회_요청(신분당선);
        응답_코드_확인(response, HttpStatus.OK);
        지하철_노선에_등록된_지하철_역_목록_확인(response, 강남역, 정자역);
    }
