...
class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        신분당선 = 지하철_노선_생성_요청(lineCreateParams, token).jsonPath().getLong("id");
    ...
    void addLineSection() {
        ...
        지하철_노선에_지하철_구간_생성_요청(신분당선, createSectionCreateParams(양재역, 정자역), token);
    ...
    void addLineSectionMiddle() {
        // when
        Long 정자역 = 지하철역_생성_요청("정자역").jsonPath().getLong("id");
        지하철_노선에_지하철_구간_생성_요청(신분당선, createSectionCreateParams(강남역, 정자역), token);
    ...
    void addSectionAlreadyIncluded() {
        // when
        ExtractableResponse<Response> response = 지하철_노선에_지하철_구간_생성_요청(신분당선, createSectionCreateParams(강남역, 양재역), token);
    ...
    void removeLineSection() {
        ...
        // when
        지하철_노선에_지하철_구간_제거_요청(신분당선, 정자역, token);
    ...
    void removeLineSectionInMiddle() {
        ...
        // when
        지하철_노선에_지하철_구간_제거_요청(신분당선, 양재역, token);
