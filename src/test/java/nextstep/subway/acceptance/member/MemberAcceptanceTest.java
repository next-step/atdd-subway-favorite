...
class MemberAcceptanceTest extends AcceptanceTest {
    ...
    void manageMyInfo() {
        ...
        // given
        String accessToken = 로그인_요청(EMAIL, PASSWORD).jsonPath().getString(ACCESS_TOKEN);
        // when
        ...
        // given
        String newAccessToken = 로그인_요청(NEW_EMAIL, NEW_PASSWORD).jsonPath().getString(ACCESS_TOKEN);
        // then
