...
class StationAcceptanceTest extends AcceptanceTest {
    ...
    void createStation() {
        // when
        ExtractableResponse<Response> response = 관리자_권한으로_지하철역_생성("강남역");
    ...
    void getStations() {
        // given
        관리자_권한으로_지하철역_생성("강남역");
        관리자_권한으로_지하철역_생성("역삼역");
    ...
    void deleteStation() {
        // given
        ExtractableResponse<Response> createResponse = 관리자_권한으로_지하철역_생성("강남역");
