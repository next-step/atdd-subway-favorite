...
public class LineSteps extends AcceptanceTestSteps{
    ...
    public static void 지하철_노선_수정_요청(String token, ExtractableResponse<Response> createResponse, Map<String, String> params) {
        given(token)
                .body(params)
                .contentType(MediaType.APPLICATION_JSON_VALUE)
    ...
    public static ExtractableResponse<Response> 지하철_노선_삭제_요청(String token, ExtractableResponse<Response> createResponse) {
        return given(token)
