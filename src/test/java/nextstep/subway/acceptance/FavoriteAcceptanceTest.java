...
public class FavoriteAcceptanceTest extends AcceptanceTest {
    ...
    void registerFavorite() {
        ...
        // when (강남역 -> 양재역)
        ExtractableResponse<Response> 즐겨찾기_등록_응답 = 즐겨찾기_등록_요청(강남역, 양재역, adminAccessToken);
    ...
    void getsFavorites() {
        ...
        즐겨찾기_등록_요청(강남역, 남부터미널역, adminAccessToken);

        // when
        ExtractableResponse<Response> 즐겨찾기_조회_응답 = 즐겨찾기_조회_요청(adminAccessToken);
    ...
    void deleteFavorite() {
        ...
        // given
        ExtractableResponse<Response> 즐겨찾기_등록_응답 = 즐겨찾기_등록_요청(교대역, 양재역, adminAccessToken);

        // when
        ExtractableResponse<Response> 즐겨찾기_삭제_응답 = 즐겨찾기_삭제_요청(즐겨찾기_등록_응답.header("location"), adminAccessToken);
