...
class PathAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        남부터미널역 = 지하철역_생성_요청(ADMIN_ACCESS_TOKEN, "남부터미널역").jsonPath().getLong("id");

        이호선 = 지하철_노선_생성_요청("2호선", "green", 교대역, 강남역, 10);
        신분당선 = 지하철_노선_생성_요청("신분당선", "red", 강남역, 양재역, 10);
        삼호선 = 지하철_노선_생성_요청("3호선", "orange", 교대역, 남부터미널역, 2);

        지하철_노선에_지하철_구간_생성_요청(ADMIN_ACCESS_TOKEN, 삼호선, createSectionCreateParams(남부터미널역, 양재역, 3));
    }
    ...
    private Long 지하철_노선_생성_요청(String name, String color, Long upStation, Long downStation, int distance) {
        ...
        return LineSteps.지하철_노선_생성_요청(ADMIN_ACCESS_TOKEN, lineCreateParams).jsonPath().getLong("id");
    }
