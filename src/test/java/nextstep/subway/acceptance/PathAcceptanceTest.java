...
import static nextstep.subway.acceptance.LineSteps.관리자로_지하철_노선에_지하철_구간_생성_요청;
...
class PathAcceptanceTest extends AcceptanceTest {
    ...
    public void setUp() {
        ...
        교대역 = 관리자로_지하철역_생성_요청(관리자, "교대역").jsonPath().getLong("id");
        강남역 = 관리자로_지하철역_생성_요청(관리자, "강남역").jsonPath().getLong("id");
        양재역 = 관리자로_지하철역_생성_요청(관리자, "양재역").jsonPath().getLong("id");
        남부터미널역 = 관리자로_지하철역_생성_요청(관리자, "남부터미널역").jsonPath().getLong("id");

        이호선 = 지하철_노선_생성_요청("2호선", "green", 교대역, 강남역, 10);
        신분당선 = 지하철_노선_생성_요청("신분당선", "red", 강남역, 양재역, 10);
        삼호선 = 지하철_노선_생성_요청("3호선", "orange", 교대역, 남부터미널역, 2);

        관리자로_지하철_노선에_지하철_구간_생성_요청(관리자, 삼호선, createSectionCreateParams(남부터미널역, 양재역, 3));
    }
