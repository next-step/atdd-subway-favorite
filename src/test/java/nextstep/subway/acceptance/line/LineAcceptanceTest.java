...
class LineAcceptanceTest extends AcceptanceTest {
    ...
    void updateLine() {
        ...
        // when
        Map<String, String> params = Map.of("color", "red");
        지하철_노선_수정_요청(createResponse, params, adminAccessToken);
    ...
    void deleteLine() {
        ...
        // when
        ExtractableResponse<Response> response = 지하철_노선_삭제_요청(createResponse, adminAccessToken);
