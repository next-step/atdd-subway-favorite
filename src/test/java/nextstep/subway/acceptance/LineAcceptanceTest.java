...
class LineAcceptanceTest extends AcceptanceTest {
    ...
    void createLine() {
        // when
        ExtractableResponse<Response> response = 지하철_노선_생성_요청(ADMIN_ACCESS_TOKEN, "2호선", "green");
    ...
    void getLines() {
        // given
        지하철_노선_생성_요청(ADMIN_ACCESS_TOKEN, "2호선", "green");
        지하철_노선_생성_요청(ADMIN_ACCESS_TOKEN, "3호선", "orange");
