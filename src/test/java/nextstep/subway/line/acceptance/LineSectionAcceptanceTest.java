...
public class LineSectionAcceptanceTest extends AcceptanceTest {
    ...
    void addLineSection() {
        // when
        지하철_노선에_지하철역_등록_요청(로그인_사용자, 신분당선, 양재역, 정자역, 6, 10);

        // then
        ExtractableResponse<Response> response = 지하철_노선_조회_요청(로그인_사용자, 신분당선);
    ...
    void addLineSectionAlreadyIncluded() {// given
        ...
        // when
        ExtractableResponse<Response> response = 지하철_노선에_지하철역_등록_요청(로그인_사용자, 신분당선, 양재역, 정자역, 6, 10);
    ...
    void removeLineSection() {
        ...
        // when
        ExtractableResponse<Response> removeResponse = 지하철_노선에_지하철역_제외_요청(로그인_사용자, 신분당선, 정자역);
    ...
    void removeLineSectionOnlyOneSection() {
        // when
        ExtractableResponse<Response> removeResponse = 지하철_노선에_지하철역_제외_요청(로그인_사용자, 신분당선, 양재역);
