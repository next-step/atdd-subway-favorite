...
public class LineSteps {
    ...
    public static ExtractableResponse<Response> 노선_목록_조회_요청(String uri) {
        return RestAssured
                .given().log().all()
    ...
    public static ExtractableResponse<Response> 노선_수정_요청(ExtractableResponse<Response> response, LineRequest params) {
    ...
    public static ExtractableResponse<Response> 노선_제거_요청(ExtractableResponse<Response> response) {
        String uri = response.header("Location");
    ...
    public static void 노선_생성됨(ExtractableResponse response) {
    ...
    public static void 노선_응답됨(ExtractableResponse<Response> response, ExtractableResponse<Response> createdResponse) {
        assertThat(response.statusCode()).isEqualTo(HttpStatus.OK.value());
    ...
    public static ExtractableResponse<Response> 노선_등록되어_있음(LineRequest params) {
