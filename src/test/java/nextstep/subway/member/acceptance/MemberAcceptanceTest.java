...
public class MemberAcceptanceTest extends AcceptanceTest {
    ...
    @DisplayName("회원 정보를 관리한다. with Token")
    @Test
    void manageMemberWithToken() {
        ...
        // when
        ExtractableResponse<Response> updateResponse = 회원_정보_수정_요청_Token(createResponse, tokenResponse, "new" + EMAIL, "new" + PASSWORD, AGE);
        // then
        회원_정보_수정됨(updateResponse);

        // when
        ExtractableResponse<Response> deleteResponse = 회원_삭제_요청_Token(createResponse, tokenResponse);
        // then
        회원_삭제됨(deleteResponse);
    }
}
