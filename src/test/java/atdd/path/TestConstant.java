...
public class TestConstant {
    ...
    public static final String MEMBER_EMAIL = "boorwonie@email.com";
    public static final String MEMBER_NAME = "브라운";
    public static final String MEMBER_PASSWORD = "subway";
}
